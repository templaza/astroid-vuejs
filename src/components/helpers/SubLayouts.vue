    ...
    <div>
        ...
        <div v-else class="astroid-layout px-2">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button v-if="formInfo.name === `` || formInfo.default" type="button" class="btn btn-sm btn-as btn-primary btn-as-primary" @click.prevent="saveLayout('save_dialog')" :disabled="save_disabled" v-html="language.JSAVEANDCLOSE"></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="as-sublayout-bottom-toolbox sticky-bottom bg-body-tertiary px-4 py-3 border border-bottom-0 rounded-top-3 mt-5">
                ...
                <a href="#" @click.prevent="saveLayout('save')" class="btn btn-sm btn-as btn-primary me-2" :disabled="save_disabled" v-html="language.JSAVEANDCLOSE"></a>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-sm btn-as btn-primary btn-as-primary" @click.prevent="importLayout('save_dialog')" :disabled="save_disabled" v-html="language.JSAVEANDCLOSE"></button>
                        </div>
                    </div>
                </div>
            </div>
