    ...
    <nav class="container-xxl as-gutter flex-wrap flex-lg-nowrap" :class="{'px-xxl-0': constant.cms_name === 'moodle'}" aria-label="Main navigation">
      ...
      <a class="navbar-brand astroid-logo p-0 me-0 me-lg-4 d-flex align-items-center" href="javascript:void(0);" aria-label="Astroid">
        <div class="fa-layers me-1" full-width="">
            ...
            <span class="fa-layers-counter fa-layers-bottom-right astroid-version">v{{ props.config.astroid_lib.version }}</span>
        </div>
      ...
      <div class="offcanvas-lg offcanvas-end flex-grow-1" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel" data-bs-scroll="true">
        ...
        <div class="offcanvas-body p-4 pt-0 p-lg-0">
          ...
          <div class="cta-button d-lg-flex">
            ...
            <ul class="navbar-nav flex-row flex-wrap my-auto">
          ...
          <hr class="d-lg-none">
          <ul class="navbar-nav flex-row flex-wrap ms-md-auto my-auto">
          ...
          <div v-if="constant.cms_name !== `moodle`" class="astroid-color-mode d-lg-flex align-items-center ms-lg-2">
            <hr class="d-lg-none">
